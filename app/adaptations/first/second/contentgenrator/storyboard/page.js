            ...
            <div className='w-3/4 mt-14  bg-opacity-20 bg-black rounded-lg p-2'>
                <div className="w-full flex justify-between bg-purple-950 p-4">
                    ...
                    <div className="flex space-x-4">
                        <button className="bg-[#6200EE] text-white px-4 py-2 hover:bg-purple-500 rounded-lg">Submit</button>
                        <Link href="/adaptations/first/second/contentgenrator/storyboard/extract">
                        <button className="bg-[#6200EE] text-white px-4 py-2 hover:bg-purple-500 rounded-lg">Extract Character</button>
                        </Link>
